            ...
            dbc.Row([
                dbc.Col(dbc.Card(dbc.CardBody([
                    html.H5(["Total Publications ",
                             html.I(className="bi bi-info-circle-fill", id="tooltip-total-pubs", style={"cursor":
"pointer"})]),
                ...
                dbc.Col(dbc.Card(dbc.CardBody([
                    html.H5(["Avg Pubs Per Year ",
                             html.I(className="bi bi-info-circle-fill", id="tooltip-avg-pubs-year", style={"cursor":
"pointer"})]),
                ...
                dbc.Col(dbc.Card(dbc.CardBody([
                    html.H5(["% Pubs in Top 10% ",
                             html.I(className="bi bi-info-circle-fill", id="tooltip-top10", style={"cursor":
"pointer"})]),
                ...
                dbc.Col(dbc.Card(dbc.CardBody([
                    html.H5(["Avg Weighted RCR ",
                             html.I(className="bi bi-info-circle-fill", id="tooltip-avg-rcr", style={"cursor":
"pointer"})]),
                    html.H3(id="avg-rcr")
            ...
            dbc.Tooltip("Total number of publications by the selected scientist(s).", target="tooltip-total-pubs",
placement="top"),
            dbc.Tooltip("Average number of publications per year.", target="tooltip-avg-pubs-year", placement="top"),
            dbc.Tooltip("Percentage of publications ranked in the top 10% by citations.", target="tooltip-top10",
placement="top"),
            dbc.Tooltip("Average weighted Relative Citation Ratio, indicating citation impact.",
target="tooltip-avg-rcr",
placement="top"),
        ])
            ...
            dbc.Row([
                dbc.Col(dbc.Card(dbc.CardBody([
                    html.H5(["Avg Impact Factor ",
                             html.I(className="bi bi-info-circle-fill", id="tooltip-avg-impact", style={"cursor":
"pointer"})]),
        ...
        # Tooltips
        dbc.Tooltip("Average journal impact factor for top 5 post-award publications.", target="tooltip-avg-impact",
placement="top"),
    ])
